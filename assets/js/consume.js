...
const DATA = {
  1: {
    ...
    ans: 1,
    explain:
      "選擇「非籠飼雞蛋」是一種友善環境、友善動物的消費方式，代表我們重視動物福利。",
  },
  2: {
    qSize: "45px",
    eSize: "45px",
  ...
  3: {
    ...
    ans: 0,
    explain:
      "走路或騎腳踏車最環保，碳排放最低；如果路程太遠，搭大眾交通工具也比自己開車更友善環境。",
  },
  4: {
    qSize: "50px",
    eSize: "40px",
    ...
    ans: 0,
    explain:
      "負責任的消費就是要避免浪費。吃不完就丟掉不但浪費食物，也浪費種植、運輸所用的水和能源。點適量、吃得完，才是對環境和社會負責。",
  },
  5: {
    qSize: "40px",
    eSize: "40px",
    ...
    ans: 2,
    explain:
      "便宜但容易壞掉的東西，買了不久又要換，反而更浪費錢和資源。選擇耐用的產品，可以用更久，也能減少垃圾，這就是負責任的消費。",
  },
  6: {
    qSize: "50px",
    eSize: "50px",
